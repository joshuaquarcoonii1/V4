...
const Paystack = ({ paystackKey, billingEmail, phone, lastName, firstName, amount = '0.00', currency = 'NGN', channels = ['card'], refNumber, billingName, plan, invoice_limit, subaccount, split_code, split, handleWebViewMessage, onCancel, autoStart = false, onSuccess, activityIndicatorColor = 'green', modalProps, metadata }, ref) => {
    ...
    return (<react_native_1.Modal style={{ flex: 1 }} visible={showModal} animationType="slide" transparent={false} {...modalProps}>
